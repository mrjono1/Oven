...
export class AppComponent implements OnInit, OnDestroy {{
    ...
    // This will go at the END of your title for example ""Home - {Project.Title}"" <-- after the dash (-)
    private endPageTitle: string = '{Project.Title}';
    // If no Title is provided, we'll use a default one before the dash(-)
    private defaultPageTitle: string = '{Project.Title}';
