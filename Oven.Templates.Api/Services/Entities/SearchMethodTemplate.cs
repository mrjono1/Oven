...
namespace Oven.Templates.Api.Services.Entities
{
    ...
    public class SearchMethodTemplate
    {
        ...
        /// </summary>
        public async Task<{screenSection.SearchSection.SearchItemClass}[]> Search{actionName}Async([FromQuery]{screenSection.SearchSection.SearchRequestClass} request)
        {{
            if (request == null)
            {{
