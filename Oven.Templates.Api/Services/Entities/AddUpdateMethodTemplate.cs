...
namespace Oven.Templates.Api.Services.Entities
{
    /// <summary>
...
{string.Join(Environment.NewLine, childProperties)}
        ...
        /// {Screen.Title} Update
        /// </summary>
        public async Task<Guid> UpdateAsync([FromRoute]Guid id, [FromBody]{Screen.InternalName}Request put)
        {{
            if (put == null)
            {{
...
{string.Join(Environment.NewLine, properties)}
        ...
        /// {Screen.Title} Add
        /// </summary>
        public async Task<{Screen.FormResponseClass}> CreateAsync([FromBody]{Screen.InternalName}Request post)
        {{
            if (post == null)
            {{
                throw new ArgumentNullException(); 
