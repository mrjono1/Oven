...
namespace MasterBuilder.Templates.React.Helpers
{
    /// <summary>
    ...
    public class ExpressionHelper
    {
        ...
        public ExpressionHelper(Screen screen)
        {
            Screen = screen;
            ScreenSections = screen.ScreenSections.Where(a => a.ScreenSectionType == ScreenSectionType.Form);
        }

        /// <summary>
        /// Get Generated Experession
        /// </summary>
        public string GetExpression(Expression expression, string objectName)
        {
        ...
        private IEnumerable<FormField> GetFilterProperties(Expression expression)
        {
        ...
        private string GetLeft(Expression expression, string objectName)
        {
            ...
            return $@"{objectName}.{property.InternalNameJavaScript}";
        }
