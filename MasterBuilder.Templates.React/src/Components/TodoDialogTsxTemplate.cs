...
{
    /// <summary>
    /// TodoDialog.tsx Template
    /// </summary>
    public class TodoDialogTsxTemplate : ITemplate
    {
        ...
        /// Constructor
        /// </summary>
        public TodoDialogTsxTemplate(Project project)
        {
            Project = project;
        }
        ...
        {
            return @"import { Button, Dialog, DialogActions, DialogTitle, StyleRulesCallback, TextField, WithStyles, withStyles } from '@material-ui/core';
